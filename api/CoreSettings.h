...
namespace webserver {
	static const vector<ApiSettingItem> coreSettings = {
		...
		{ "log_main_file", SettingsManager::LOG_FILE_MAIN_CHAT, ResourceManager::FILENAME, ApiSettingItem::TYPE_FILE_PATH },
		...
		{ "log_pm_file", SettingsManager::LOG_FILE_PRIVATE_CHAT, ResourceManager::FILENAME, ApiSettingItem::TYPE_FILE_PATH },
		...
		{ "log_downloads_file", SettingsManager::LOG_FILE_DOWNLOAD, ResourceManager::FILENAME, ApiSettingItem::TYPE_FILE_PATH },
		...
		{ "log_uploads_file", SettingsManager::LOG_FILE_UPLOAD, ResourceManager::FILENAME, ApiSettingItem::TYPE_FILE_PATH },
		...
		{ "log_syslog_file", SettingsManager::LOG_FILE_SYSTEM, ResourceManager::FILENAME, ApiSettingItem::TYPE_FILE_PATH },
