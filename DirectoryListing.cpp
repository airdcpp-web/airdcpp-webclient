...
void DirectoryListing::onRemovedQueue(const string& aDir) {
...
void DirectoryListing::waitActionFinish() const {
	while (waiting)
		sleep(50);
}
...
void DirectoryListing::removedQueueImpl(const string& aDir) {
