...
enum Strings { // @DontAdd
	...
	REFRESH_QUEUED, // "Filelist refresh has been queued"
	...
	FILES_ADDED_FOR_HASH, // "(%s of files have been added for hashing; they won't be visible in the filelist until they have finished hashing)"
	BUNDLE_ADDED_FOR_HASH,  // "The bundle %s has been added for hashing (total size to hash: %s)"
	HASHING_FINISHED_TOTAL,  // "Hashing finished: %d directories (%s of files) have been hashed in %s (average hashing speed: %s)"
	HASHING_FINISHED_TOTAL_DIR,  // "The directory %s has finished hashing (%s of files have been hashed in %s, average hashing speed: %s)"
	HASHING_FINISHED_DIR,  // "The directory %s has finished hashing"
