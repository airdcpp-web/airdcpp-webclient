...
enum Strings { // @DontAdd
	...
	DOCUMENT, // "Document"
	DONE, // "Done"
	DONT_ADD_SEGMENT_TEXT, // "Do not begin new segment if overall file speed is over"
	...
	HASH_PROGRESS_TEXT, // "Please wait while AirDC++ indexes your files (they will not be shared until they have been indexed)..."
	...
	MAGNET_DLG_TEXT_BAD, // "A MAGNET link was given to AirDC++, but it did not contain a valid file hash for use on the Direct Connect network.  No action will be taken."
	...
	NO_DOWNLOADS_FROM_SELF, // "You are trying to download from yourself!"
	NO_ERRORS, // "No errors"
	...
	ONLY_WHERE_OP, // "Only where I am OP"
	OPEN, // "Open"
	...
	REGEXP_MATCH, // "It is a match!"
	REGEXP_MISMATCH, // "It is not a match."
	REGEXP, // "RegExp"
	...
	REDIRECT_ALREADY_CONNECTED, // "Redirect request received to a hub that is already connected"
	...
	SETTINGS_AUTO_KICK_NO_FAVS, // "Do not automatically disconnect favorite users who leave the hub"
	...
	SETTINGS_DISPLAY_DC_UPDATE, // "Do not announce new AirDC++ versions (version.xml is still downloaded)"
	SETTINGS_DONT_DL_ALREADY_SHARED, // "Do not download files already in share"
	...
	SETTINGS_KEEP_LISTS, // "Do not delete file lists when exiting"
	...
	SETTINGS_NO_AWAYMSG_TO_BOTS, // "Do not send the away message to bots"
	...
	SETTINGS_OVERRIDE, // "Do not allow hub/UPnP to override"
	...
	SOCKS_AUTH_UNSUPPORTED, // "The socks server does not support login / password authentication"
	...
	CERTIFICATES_EXPERIMENTAL, // "Experimental feature, do not consider AirDC++ secure in any way"
	...
	NO_MEDIA_SPAM, // "Selected player does not support media spams"
	...
	ST_SKIPLIST_SHARE, // "Do not share the following files (separate files with '|', wildcards allowed):"
	...
	ADD_EMPTY, // "Cannot add an empty string"
	BAD_REGEXP, // "Badly formatted regular expression"
	AIRDC, // "AirDC++"
	FLASH_WINDOW_ON_PM, // "Flash window on PM"
	FLASH_WINDOW_ON_NEW_PM, // "Flash window on PM only if it is from a new user"
	...
	SETTING_DONT_DL_ALREADY_QUEUED, // "Do not download files already in queue"
	...
	NO_CRC32, // "No SFV file found or the selected file is not listed in it"
	...
	NO_PARTIAL_SUPPORT, // "The remote client does not support this feature"
	...
	DONT_SHARE_BIGGER_THAN, // "Do not share files bigger than (0=disable)"
	...
	SETTINGS_NO_ZERO_BYTE, // "Do not share 0 byte files"
	...
	SCAN_FAILED_BUNDLE_FINISHED, // "The bundle %s will not be shared because the following problems were found: "
	...
	ADLSEARCH_IN_PROGRESS, // "The ADL search list cannot be modified while matching is in progress!"
	...
	BUNDLE_MERGED, // "The directory %s has been merged into an existing bundle %s (%d items were merged)"
	X_BUNDLE_ITEMS_ADDED, // "%d items were added into an existing bundle %s"
	BUNDLE_ITEM_ADDED, // "The file %s was added into an existing bundle %s"
	...
	NOT_IN_SHARED_DIR, // "The bundle %s is not in a shared folder, please add it in share manually"
	...
	BUNDLE_READDED, // "A failed bundle %s has been re-added in queue"
	...
	SETTINGS_EXPIRY_DAYS, // "The default expiry days for items (0 = will not expire)"
	...
	FORCE_HASH_NOTIFICATION, // "Refresh the directory after fixing the problem(s) to rescan the bundle (or type \"/allow %s\" to force it to be hashed in share if the problem(s) cannot be fixed)"
	LINE_EMPTY_OR_TOO_SHORT, // "Search string empty or too short! (min. 5 chars allowed)"
	AUTOSEARCH_CHECK_QUEUED, // "Do not download directories already in queue"
	AUTOSEARCH_CHECK_SHARED, // "Do not download directories already in share"
	...
	NO_FILE_ACCESS, // "You do not have access to this file"
	...
	FILES_ADDED_FOR_HASH, // "(%s of files have been added for hashing; they will not be visible in the file list until they have finished hashing)"
	...
	UPDATER_START, // "Update is being downloaded and installed, you will be notified again when your attention is required."
	...
	NO_INCOMING_CONFIGURED, // "You do not have any incoming directories configured!"
	...
	MANUAL_UPDATE_MSG, // "You will be forwarded to the downloading page as automatic updating cannot be performed"
	...
	DIRECTORY_NOT_REMOVED,  // "The directory %s is not empty, not removed"
	...
	PM_MAGNET_SHARED_WARNING, // "The download destination %s is a shared directory. Files sent in private chat may contain sensitive information that you or the sender do not want to be made available for other user.\r\n\r\nDo you want to use this destination anyway?"
	...
	AS_X_FOUND_FROM, // "A %s %s was found from a user %s"
	...
	REMOTE_PROTOCOL_UNSUPPORTED, // "The remote user does not support %s protocol"
	CONNECTING_IN_PROGRESS, // "Connecting to the hub in progress"
	MODE_V4, // "Mode (IPv4)"
	MODE_V6, // "Mode (IPv6)"
	IP_V4, // "IP (v4)"
	IP_V6, // "IP (v6)"
	NO_NATT_SUPPORT, // "The remote user does not support passive-passive connections"
	...
	BIND_ADDRESS_MISSING, // "The %s bind address %s does not appear to be available. Do you want to switch to listen to all interfaces?"
	DUPLICATE, // "Duplicate"
	...
	PM_PERMISSION_DENIED, // "You are not allowed to send private messages to this user"
	MAIN_PERMISSION_DENIED, // "You are not allowed to send messages to main chat"
	INACTIVE, // "Inactive"
	...
	CANT_OPEN_EMPTY_FILE, // "A zero-byte file cannot be opened"
	LIST_ALREADY_QUEUED, // "The file list is queued already"
	FILE_X_QUEUED, // "The file %s has been added in queue (%s)"
	ADD_BUNDLE_ERRORS_OCC, // "The following error(s) occurred when queueing the bundle %s from a user %s: %s"
	...
	BACK, // "Back"
	FORWARD, // "Forward"
	AS_ERROR, // "%s: %s (on %s from a user %s)"
	...
	DB_OPEN_FAILED_IO, // "Failed to open %s: %s\r\n\r\nMake sure that there is not another instance of %s using the same settings directory and that the directory %s is accessible. %s will now exit."
	DB_OPEN_FAILED_REPAIR, // "Failed to open %s: %s\r\n\r\n%s will now attempt to repair it automatically."
	DB_REPAIR_FAILED, // "Failed to repair %s: %s\r\n\r\nMake sure that the path %s is accessible and there is not another instance of %s using the same settings directory. Remove the directory in case the error cannot be fixed."
	...
	WIZARD_SHARING_INTRO, // "Choose the folders that you want to share to other users. This step is not mandatory, but sharing files to other users will allow joining more hubs."
	...
	WIZARD_CONNECTION_SPEED_INTRO, // "Choose your download and upload speed. You may also type in custom values if your speed is not listed. Please be as accurate as possible and set the ACTUAL speed of your connection."
	...
	MANUALLY_CONFIGURED_MSG, // "There are %d settings that have manually set values. Do you want to replace those with the predefined values used by the profile %s?"
	SHOW_CONFLICTING, // "Show conflicting settings"
	SETTING_NAME_X, // "Setting name: %s"
	CURRENT_VALUE_X, // "Current value: %s"
	PROFILE_VALUE_X, // "Profile value: %s"
	...
	SCAN_SHARE_DIR_FAILED, // "The directory %s will not be shared because the following problems were found: %s"
	...
	HASHING, // "Hashing"
	TREE_LOAD_FAILED, // "Failed to load hash data for a TTH root %s: %s (consider verifying the hash database by typing /verifydb)"
	...
	HASHDB_MAINTENANCE_UNUSED, // "Hash database maintenance completed: %d unused file entries and %d unused tree entries have been removed"
	...
	OPTIMIZE_DB_HELP, // "This will remove the database entries for files and trees that are not shared anymore."
	...
	OPTIMIZE_CONFIRMATION, // "This operation will delete all hash information for files that are not currently in share. If you are sharing files from network disks or from a removable storage, make sure that the files are currently shown in share (otherwise they have to be rehashed).\r\n\r\nDo you want to continue?"
	...
	REBUILD_FAILED_ENTRIES_VERIFY, // "There were %d shared TTHs without a corresponding hash tree entry and %d invalid tree entries that could not be loaded"
	REBUILD_FAILED_ENTRIES_OPTIMIZE, // "%d shared TTHs without a corresponding hash tree entry were found"
	REBUILD_REFRESH_PROMPT, // "It is recommended to refresh your share as those files (total of %s) must be rehashed if they are still shared"
