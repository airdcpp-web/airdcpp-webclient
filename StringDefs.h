...
enum Strings { // @DontAdd
	...
	BUNDLE_CREATED, // "The bundle %s has been created with %d items (total size: %s)"
	...
	BUNDLE_MERGED, // "The bundle %s has merged into existing bundle %s (%d items were merged)"
