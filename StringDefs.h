...
enum Strings { // @DontAdd
	...
	WIZARD_GENERAL_INTRO, // "Enter general information that you want to be displayed to other users"
	...
	WIZARD_FINISHED_INTRO, // "The wizard has been completed successfully."
