...
enum Strings { // @DontAdd
	...
	CONN_NAT_DETECTED, // "Active mode could not be achieved; a manual configuration is recommended for better connectivity"
	...
	MAPPER_CREATING_SUCCESS, // "Successfully created port mappings (Transfers: %1%, Encrypted transfers: %2%, Search: %3%) on the %4% device with the %5% interface"
	MAPPER_CREATING_SUCCESS_LONG, // "Successfully created port mappings on the %1% device with the %2% interface"
