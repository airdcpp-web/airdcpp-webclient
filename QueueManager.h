...
public:
	...
	Download* getDownload(UserConnection& aSource, string& aMessage, bool smallSlot) throw();
	...
	QueueItem::Priority hasDownload(const UserPtr& aUser, bool smallSlot) throw();
