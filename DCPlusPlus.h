...
extern void startup(function<void (const string&)> stepF, function<bool (const string& /*Message*/, bool /*isQuestion*/)> messageF, function<void ()> runWizard, function<void (float)> progressF);
