...
"Document", 
"Done", 
"Do not begin new segment if overall file speed is over", 
...
"Run in background", 
"Statistics", 
"Please wait while AirDC++ indexes your files (they will not be shared until they have been indexed)...", 
...
"File size:", 
"A MAGNET link was given to AirDC++, but it did not contain a valid file hash for use on the Direct Connect network.  No action will be taken.", 
...
"You are trying to download from yourself!", 
"No errors", 
"No free block", 
...
"Recent hubs", 
"Recheck integrity", 
"Redirect request received to a hub that is already connected", 
"Redirect user(s)", 
"Refresh", 
"Reliability", 
"Requesting", 
...
"Do not automatically disconnect favorite users who leave the hub", 
...
"Direct connection", 
"Directories", 
"Do not announce new AirDC++ versions (version.xml is still downloaded)", 
"Do not download files already in share", 
...
"Do not delete file lists when exiting", 
"Language file", 
"Log directory", 
"Log downloads", 
...
"Name", 
"Connection settings", 
"Do not send the away message to bots", 
"Normal", 
"timeout", 
...
"Do not allow hub/UPnP to override", 
...
"The socks server does not support login / password authentication", 
...
"Experimental feature, do not consider AirDC++ secure in any way", 
"TTH Inconsistency", 
"TTH root", 
"Two colors", 
"Type", 
...
"Selected player does not support media spams", 
"Start Media player", 
"Winamp", 
"Refresh", 
"Artist", 
...
"Do not share the following files (separate files with '|', wildcards allowed):", 
"Skiplist share", 
...
"AirDC++", 
"Flash window on PM", 
"Flash window on PM only if it is from a new user", 
...
"Do not download files already in queue", 
...
"No SFV file found or the selected file is not listed in it", 
...
"No NFO files found!", 
"Scan in progress", 
"The remote client does not support this feature", 
...
"Do not share files bigger than (0=disable)", 
...
"The bundle %s will not be shared because the following problems were found: ", 
...
"The ADL search list cannot be modified while matching is in progress!", 
...
"The directory %s has been merged into an existing bundle %s (%d items were merged)", 
"%d items were added into an existing bundle %s", 
"The file %s was added into an existing bundle %s", 
"The bundle %s has been moved to %s", 
"The instant sharing feature is disabled, please add the bundle in share manually", 
"The bundle %s is not in a shared folder, please add it in share manually", 
...
"A failed bundle %s has been re-added in queue", 
...
"The default expiry days for items (0 = will not expire)", 
"Start time", 
"End time", 
"Last search", 
"Select directory", 
...
"Location type", 
"Refresh the directory after fixing the problem(s) to rescan the bundle (or type \"/allow %s\" to force it to be hashed in share if the problem(s) cannot be fixed)", 
"Search string empty or too short! (min. 5 chars allowed)", 
"Do not download directories already in queue", 
"Do not download directories already in share", 
...
"(%s of files have been added for hashing; they will not be visible in the file list until they have finished hashing)", 
...
"Update is being downloaded and installed, you will be notified again when your attention is required.", 
...
"You do not have any incoming directories configured!", 
...
"You will be forwarded to the downloading page as automatic updating cannot be performed", 
...
"The directory %s is not empty, not removed", 
...
"The download destination %s is a shared directory. Files sent in private chat may contain sensitive information that you or the sender do not want to be made available for other user.\r\n\r\nDo you want to use this destination anyway?", 
...
"The remote user does not support %s protocol", 
"Connecting to the hub in progress", 
"Mode (IPv4)", 
"Mode (IPv6)", 
"IP (v4)", 
"IP (v6)", 
"The remote user does not support passive-passive connections", 
...
"The %s bind address %s does not appear to be available. Do you want to switch to listen to all interfaces?", 
"Duplicate", 
"Partial match", 
"RegEx", 
"Wildcard", 
...
"You are not allowed to send private messages to this user", 
"You are not allowed to send messages to main chat", 
"Inactive", 
...
"A zero-byte file cannot be opened", 
"The file list is queued already", 
"The file %s has been added in queue (%s)", 
"The following error(s) occurred when queueing the bundle %s from a user %s: %s", 
"%s (%d out of %d bundle files were affected)", 
"%s (affected file(s): %s)", 
...
"Do not share empty directories", 
"Scanning options", 
...
"Choose the folders that you want to share to other users. This step is not mandatory, but sharing files to other users will allow joining more hubs.", 
...
"Choose your download and upload speed. You may also type in custom values if your speed is not listed. Please be as accurate as possible and set the ACTUAL speed of your connection.", 
...
"There are %d settings that have manually set values. Do you want to replace those with the predefined values used by the profile %s?", 
...
"The directory %s will not be shared because the following problems were found: %s", 
"Scanning failed: %s", 
"%d files failed to hash", 
"%s (failed sharing)", 
"%s (missing files)", 
"Hashing", 
"Failed to load hash data for a TTH root %s: %s (consider verifying the hash database by typing /verifydb)", 
"Hash database maintenance started...", 
"Failed to complete the hash database maintenance", 
"Hash database maintenance completed: %d unused file entries and %d unused tree entries have been removed", 
"Hash database maintenance finished, no unused entries were found", 
"Optimize databases", 
"This will remove the database entries for files and trees that are not shared anymore.", 
...
"This operation will delete all hash information for files that are not currently in share. If you are sharing files from network disks or from a removable storage, make sure that the files are currently shown in share (otherwise they have to be rehashed).\r\n\r\nDo you want to continue?", 
...
"%d directories have been removed from monitoring", 
"Failed to add the directory %s for monitoring: %s", 
"Detect now", 
...
"There were %d shared TTHs without a corresponding hash tree entry and %d invalid tree entries that could not be loaded", 
"%d shared TTHs without a corresponding hash tree entry were found", 
"It is recommended to refresh your share as those files (total of %s) must be rehashed if they are still shared", 
"Confirm file deletions", 
"A failed directory %s has been removed from monitoring: %s", 
"This user does not support the advanced searching features in partial lists, which may result in lower hit counts.", 
"Searching from the whole share via partial list is not supported in NMDC hubs. It is recommended to use the full list instead.", 
