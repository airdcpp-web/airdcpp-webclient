...
"The directory %s has been added in share (it is not visible in the filelist until it has finished hashing)", 
"%d directories has been added in share (they are not visible in the filelist until the have finished hashing)", 
