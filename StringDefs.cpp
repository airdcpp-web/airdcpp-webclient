...
"(%s of files have been added for hashing; they won't be visible in the filelist until they have finished hashing)", 
"The bundle %s has been added for hashing (total size to hash: %s)", 
"Hashing finished: %d directories (%s of files) have been hashed in %s (average hashing speed: %s)", 
"The directory %s has finished hashing (%s of files have been hashed in %s, average hashing speed: %s)", 
"The directory %s has finished hashing", 
