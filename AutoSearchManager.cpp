...
AutoSearch::AutoSearch() noexcept : token(Util::randInt(10)), status(STATUS_SEARCHING), nextIsDisable(false), enabled(true), manualSearch(false), nextSearchChange(0), lastIncFinish(0), lastSearch(0) { 
