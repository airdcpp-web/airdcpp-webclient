/*
 * Copyright (C) 20 01-2017 Jacek Sieka, arnetheduck on gmailpoint com
 *
...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		DISCONNECT_FILESIZE, NUMBER_OF_SEGMENTS, MAX_HASH_SPEED, MAX_PM_HISTORY_LINES, SEARCH_ALTERNATE_COLOUR, BUNDLE_SEARCH_TIME, DONT_BEGIN_SEGMENT_SPEED,
