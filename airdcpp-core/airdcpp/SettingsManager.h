...
public:
	...
	enum BoolSetting { BOOL_FIRST = INT_LAST + 1,
		...
		CHECK_NFO, CHECK_MP3_DIR, CHECK_EXTRA_SFV_NFO, CHECK_EXTRA_FILES, CHECK_DUPES, CHECK_DISK_COUNTS, SORT_DIRS, WIZARD_RUN, FORMAT_RELEASE, TEXT_NORM_BOLD, TEXT_NORM_ITALIC, SYSTEM_SHOW_UPLOADS, SYSTEM_SHOW_DOWNLOADS,
