...
private:
	...
	void on(QueueManagerListener::Finished, const QueueItem*, const string&, const HintedUser& aUser, int64_t aSpeed) noexcept;
...
/**
 * @file
 * $Id: FinishedManager.h 568 2011-07-24 18:28:43Z bigmuscle $
 */
