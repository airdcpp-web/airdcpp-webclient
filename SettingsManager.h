...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		DISCONNECT_FILESIZE, NUMBER_OF_SEGMENTS, MAX_HASH_SPEED, SHOW_LAST_LINES_LOG, SEARCH_ALTERNATE_COLOUR, SEARCH_TIME, DONT_BEGIN_SEGMENT, DONT_BEGIN_SEGMENT_SPEED,
	...
	enum BoolSetting { BOOL_FIRST = INT_LAST + 1,
		...
		SEARCH_MERGE, SEARCH_ONLY_FREE_SLOTS, SEGMENTED_DL, SEND_UNKNOWN_COMMANDS,
		...
		PRIVATE_MESSAGE_BEEP, PRIVATE_MESSAGE_BEEP_OPEN, SHOW_PROGRESS_BARS, MDI_MAXIMIZED, SEARCH_PASSIVE, REMOVE_FORBIDDEN, SHOW_INFOTIPS, MINIMIZE_ON_STARTUP, CONFIRM_DELETE, EXPAND_QUEUE, 
		...
		//AirDC
		USE_ADLS_OWN, AUTO_DETECTION_USE_LIMITED, LOG_SCHEDULED_REFRESHES, AUTO_COMPLETE_BUNDLES, SEARCH_SAVE_HUBS_STATE, CONFIRM_HUB_EXIT, CONFIRM_AS_REMOVE, ENABLE_SUDP, NMDC_MAGNET_WARN,
		...
		PM_PREVIEW, IGNORE_USE_REGEXP_OR_WC, NAT_SORT, HUB_BOLD_TABS, SHOW_WINAMP_CONTROL, BLEND_TABS, TAB_SHOW_ICONS, ALLOW_MATCH_FULL_LIST,
		BOOL_LAST };
