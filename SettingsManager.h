...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		MAX_HASH_SPEED, GET_USER_COUNTRY,
		...
		COLOR_DOWNLOADED, COLOR_RUNNING, COLOR_DONE, AUTO_REFRESH_TIME, OPEN_WAITING_USERS, 
		...
		SLOTS_ALTERNATE_LIMITING, SLOTS_PRIMARY, TIME_DEPENDENT_THROTTLE,
		...
		FIRST_RUN, MAX_RESIZE_LINES,
		DUPE_SEARCH, PASSWD_PROTECT, PASSWD_PROTECT_TRAY,
		DISALLOW_CONNECTION_TO_PASSED_HUBS, BOLD_HUB_TABS_ON_KICK, SEARCH_SKIPLIST,
		AUTO_ADD_SOURCE, KEEP_FINISHED_FILES, ALLOW_NAT_TRAVERSAL, USE_EXPLORER_THEME, TESTWRITE, INCOMING_REFRESH_TIME, USE_ADLS,
		...
		USE_PARTIAL_SHARING, POPUP_BUNDLE_DLS, POPUP_BUNDLE_ULS, QUEUE_COLOR, TEXT_QUEUE_BACK_COLOR, TEXT_QUEUE_BOLD, TEXT_QUEUE_ITALIC, UNDERLINE_QUEUE, LOG_HASHING,
		RECENT_BUNDLE_HOURS, USE_FTP_LOGGER, QI_AUTOPRIO, SHOW_SHARED_DIRS_FAV, REPORT_ADDED_SOURCES, EXPAND_BUNDLES, OVERLAP_SLOW_SOURCES, FORMAT_DIR_REMOTE_TIME,
		...
		DL_AUTOSELECT_METHOD, WTB_IMAGE_SIZE, SHOW_TBSTATUS, TB_PROGRESS_TEXT_COLOR, LOCK_TB, CLEAR_DIR_HISTORY, POPUNDER_PARTIAL_LIST, TLS_MODE, UPDATE_METHOD,
		QUEUE_SPLITTER_POS, UPDATE_IP_HOURLY, POPUNDER_TEXT, FULL_LIST_DL_LIMIT, SEARCH_SAVE_HUBS_STATE, CONFIRM_HUB_EXIT, CONFIRM_AS_REMOVE, ENABLE_SUDP, NMDC_MAGNET_WARN,
		AUTO_COMPLETE_BUNDLES, LOG_SCHEDULED_REFRESHES, AUTO_DETECTION_USE_LIMITED, USE_ADLS_OWN, AS_DELAY_HOURS, LAST_LIST_PROFILE, MAX_HASHING_THREADS, HASHERS_PER_VOLUME,
		INT_LAST };
