...
public:
	...
	enum BoolSetting { BOOL_FIRST = INT_LAST + 1,
		...
		PM_PREVIEW, IGNORE_USE_REGEXP_OR_WC, NAT_SORT, HUB_BOLD_TABS, SHOW_WINAMP_CONTROL, BLEND_TABS, TAB_SHOW_ICONS, ALLOW_MATCH_FULL_LIST, SHOW_CHAT_NOTIFY, FREE_SPACE_WARN,
		BOOL_LAST };
