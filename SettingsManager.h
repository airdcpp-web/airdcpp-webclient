...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		USERS_FRAME_VISIBLE, LIST_VIEW_FONT,
		STR_LAST };
	...
	enum BoolSetting { BOOL_FIRST = INT_LAST + 1,
		...
		HISTORY_SEARCH_CLEAR, HISTORY_EXCLUDE_CLEAR, HISTORY_DIR_CLEAR, NO_IP_OVERRIDE6, IP_UPDATE6, SEARCH_USE_EXCLUDED, AUTOSEARCH_BOLD, SHOW_EMOTICON, SHOW_MULTILINE, SHOW_MAGNET, WARN_ELEVATED,
		BOOL_LAST };
