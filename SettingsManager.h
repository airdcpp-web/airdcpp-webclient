...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		MEDIATOOLBAR, PASSWORD, SKIPLIST_SEARCH, SKIP_MSG_01, SKIP_MSG_02, SKIP_MSG_03, DOWNLOAD_SPEED,
		STR_LAST };
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		SYSTEM_SHOW_UPLOADS, SYSTEM_SHOW_DOWNLOADS, SETTINGS_PROFILE, LANGUAGE_SWITCH, WIZARD_RUN, FORMAT_RELEASE, SHARE_SFV, LOG_LINES,
		...
		CHECK_EMPTY_DIRS, CHECK_EMPTY_RELEASES,
		INT_LAST };
