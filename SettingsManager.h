...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		UNDERLINE_DUPES, DUPES_IN_FILELIST, DUPES_IN_CHAT, LIST_HL_BG_COLOR, LIST_HL_COLOR, LIST_HL_BOLD, LIST_HL_ITALIC, REPORT_SKIPLIST, ENABLE_BUNDLES, SCAN_DL_BUNDLES,
		USE_PARTIAL_SHARING, POPUP_BUNDLE_DLS, POPUP_BUNDLE_ULS, QUEUE_COLOR, TEXT_QUEUE_BACK_COLOR, TEXT_QUEUE_BOLD, TEXT_QUEUE_ITALIC, UNDERLINE_QUEUE,
		INT_LAST };
