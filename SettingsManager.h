...
public:
	...
	enum BoolSetting { BOOL_FIRST = INT_LAST + 1,
		...
		ACCEPT_FAILOVERS, REMOVE_EXPIRED_AS, PM_LOG_GROUP_CID, SHARE_FOLLOW_SYMLINKS, SCAN_MONITORED_FOLDERS, FINISHED_NO_HASH, CONFIRM_FILE_DELETIONS, USE_DEFAULT_CERT_PATHS,
		BOOL_LAST };
