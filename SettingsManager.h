...
public:
	...
	enum BoolSetting { BOOL_FIRST = INT_LAST + 1,
		...
		FILTER_ENTER, SPY_FRAME_IGNORE_TTH_SEARCHES, OPEN_WAITING_USERS, BOLD_WAITING_USERS, GROUP_SEARCH_RESULTS, TABS_ON_TOP, OPEN_PUBLIC, OPEN_FAVORITE_HUBS, OPEN_FAVORITE_USERS, OPEN_QUEUE, 
