/*
 * Copyright (C
) 20 01-2014 Jacek Sieka, arnetheduck on gmailpoint com
 *
...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		MONITORING_DELAY, DELAY_COUNT_MODE, MAX_RUNNING_BUNDLES, DEFAULT_SP, UPDATE_CHANNEL,
		INT_LAST };
	...
	enum BoolSetting { BOOL_FIRST = INT_LAST + 1,
		...
		FILTER_ENTER, SPY_FRAME_IGNORE_TTH_SEARCHES, OPEN_WAITING_USERS, BOLD_WAITING_USERS, GROUP_SEARCH_RESULTS, TABS_ON_TOP, OPEN_PUBLIC, OPEN_FAVORITE_HUBS, OPEN_FAVORITE_USERS, OPEN_QUEUE, OPEN_FINISHED_DOWNLOADS, 
		...
		CHECK_NFO, CHECK_MP3_DIR, CHECK_EXTRA_SFV_NFO, CHECK_EXTRA_FILES, CHECK_DUPES, CHECK_DISK_COUNTS, SORT_DIRS, DECREASE_RAM, WIZARD_RUN_NEW, FORMAT_RELEASE, TEXT_NORM_BOLD, TEXT_NORM_ITALIC, SYSTEM_SHOW_UPLOADS, SYSTEM_SHOW_DOWNLOADS,
		...
		SEARCH_ASCH_ONLY, IGNORE_INDIRECT_SR, USE_UPLOAD_BUNDLES, CLOSE_USE_MINIMIZE, LOG_IGNORED, USERS_FILTER_IGNORE, NFO_EXTERNAL, SINGLE_CLICK_TRAY, QUEUE_SHOW_FINISHED,
		BOOL_LAST };
