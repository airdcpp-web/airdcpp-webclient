...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		FIRST_RUN, LAST_SEARCH_FILETYPE, MAX_RESIZE_LINES, DONT_SHARE_EMPTY_DIRS, ONLY_SHARE_FULL_DIRS,
		...
		DIRLIST_LEFT, DIRLIST_RIGHT, STATS_TOP, STATS_BOTTOM, STATS_LEFT, STATS_RIGHT, MAX_MCN_DOWNLOADS, PARTIAL_MATCH_ADC, NO_ZERO_BYTE,
		INT_LAST };
