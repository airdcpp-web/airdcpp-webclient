...
public:
	...
	enum BoolSetting { BOOL_FIRST = INT_LAST + 1,
		...
		PM_PREVIEW, IGNORE_USE_REGEXP_OR_WC, NAT_SORT, HUB_BOLD_TABS, SHOW_WINAMP_CONTROL, BLEND_TABS, TAB_SHOW_ICONS, ALLOW_MATCH_FULL_LIST, SHOW_CHAT_NOTIFY, FREE_SPACE_WARN, FAV_USERS_SHOW_INFO, FAV_USERS_ONLY_FAV, LOG_ALREADY_SHARED,
		HISTORY_SEARCH_CLEAR, HISTORY_EXCLUDE_CLEAR, HISTORY_DIR_CLEAR, NO_IP_OVERRIDE6, IP_UPDATE6, SEARCH_USE_EXCLUDED, AUTOSEARCH_BOLD,
		BOOL_LAST };
