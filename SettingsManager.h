/*
 * Copyright (C) 20 01-2013 Jacek Sieka, arnetheduck on gmailpoint com
 *
...
public:
	...
	enum BoolSetting { BOOL_FIRST = INT_LAST + 1,
		...
		FILTER_FL_SHARED, FILTER_FL_QUEUED, FILTER_FL_INVERSED, FILTER_SEARCH_SHARED, FILTER_SEARCH_QUEUED, FILTER_SEARCH_INVERSED,
		BOOL_LAST };
