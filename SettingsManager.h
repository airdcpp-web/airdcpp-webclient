...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		RECENTFRAME_ORDER, RECENTFRAME_WIDTHS, MAPPER, COUNTRY_FORMAT, BACKUP_PATH,
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		DL_AUTOSELECT_METHOD, WTB_IMAGE_SIZE, SHOW_TBSTATUS, TB_PROGRESS_TEXT_COLOR, LOCK_TB, CLEAR_DIR_HISTORY, POPUNDER_PARTIAL_LIST, TLS_MODE, UPDATE_METHOD, UPGRADE_AUTOBACKUP,
		QUEUE_SPLITTER_POS, UPDATE_IP_HOURLY,
		INT_LAST };
