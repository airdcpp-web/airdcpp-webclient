...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		MONITORING_DELAY, DELAY_COUNT_MODE, MAX_RUNNING_BUNDLES, DEFAULT_SP, UPDATE_CHANNEL, COLOR_STATUS_FAILED, COLOR_STATUS_FINISHED, COLOR_STATUS_HASHING, COLOR_STATUS_SHARED,
		INT_LAST };
