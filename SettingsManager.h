...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		IPUPDATE, MAX_HASH_SPEED, GET_USER_COUNTRY,
		...
		DL_AUTOSELECT_METHOD, WTB_IMAGE_SIZE, SHOW_TBSTATUS, TB_PROGRESS_TEXT_COLOR, LOCK_TB, CLEAR_DIR_HISTORY, POPUNDER_PARTIAL_LIST, TLS_MODE,
		INT_LAST };
