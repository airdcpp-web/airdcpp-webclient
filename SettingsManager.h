...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		DIRLIST_LEFT, DIRLIST_RIGHT, STATS_TOP, STATS_BOTTOM, STATS_LEFT, STATS_RIGHT, MAX_MCN_DOWNLOADS, PARTIAL_MATCH_ADC, NO_ZERO_BYTE, MAX_MCN_UPLOADS, MCN_SLOTS_AUTO,
		INT_LAST };
