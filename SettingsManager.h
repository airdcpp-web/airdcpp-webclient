...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		AUTOSEARCHFRAME_ORDER, AUTOSEARCHFRAME_WIDTHS,
		STR_LAST };
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		ALLOW_UNTRUSTED_HUBS, ALLOW_UNTRUSTED_CLIENTS, TLS_PORT, DOWNCONN_PER_SEC,
		...
		SYSTEM_SHOW_UPLOADS, SYSTEM_SHOW_DOWNLOADS, SETTINGS_PROFILE, LANGUAGE_SWITCH, WIZARD_RUN_NEW, FORMAT_RELEASE, LOG_LINES,
		...
		SHARE_SAVE_TIME, RECENT_BUNDLE_HOURS, USE_FTP_LOGGER, QI_AUTOPRIO, SHOW_SHARED_DIRS_FAV, REPORT_ADDED_SOURCES, EXPAND_BUNDLES, OVERLAP_SLOW_SOURCES,
		INT_LAST };
