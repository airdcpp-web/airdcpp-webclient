...
#ifndef DCPLUSPLUS_DCPP_DOWNLOADBUNDLE_H_
#define DCPLUSPLUS_DCPP_DOWNLOADBUNDLE_H_
 ...
 */
class DownloadBundle : public intrusive_ptr_base<DownloadBundle> {
public:
	...
	DownloadBundle(const string& target, BundlePtr queueBundle) : target(target), token(queueBundle->getToken()), queueBundle(queueBundle), downloaded(0), 
		speed(0), lastSpeed(0), running(0), lastPercent(0), singleUser(false) { }
...
#endif /* DCPLUSPLUS_DCPP_DOWNLOADBUNDLE_H_ */
