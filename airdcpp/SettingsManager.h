...
public:
	...
	enum BoolSetting { BOOL_FIRST = INT_LAST + 1,
		...
		PM_PREVIEW, IGNORE_USE_REGEXP_OR_WC, HUB_BOLD_TABS, SHOW_WINAMP_CONTROL, BLEND_TABS, TAB_SHOW_ICONS, ALLOW_MATCH_FULL_LIST, SHOW_CHAT_NOTIFY, FREE_SPACE_WARN, FAV_USERS_SHOW_INFO, LOG_ALREADY_SHARED,
		...
		REMOVE_EXPIRED_AS, PM_LOG_GROUP_CID, SHARE_FOLLOW_SYMLINKS, SCAN_MONITORED_FOLDERS, FINISHED_NO_HASH, CONFIRM_FILE_DELETIONS, USE_DEFAULT_CERT_PATHS, STARTUP_REFRESH, FL_REPORT_FILE_DUPES,
		...
		FILTER_QUEUE_INVERSED, FILTER_QUEUE_TOP, FILTER_QUEUE_RESET_CHANGE, ALWAYS_CCPM, SEPARATE_NOSHARE_HUBS,
		BOOL_LAST };
