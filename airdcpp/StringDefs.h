...
enum Strings { // @DontAdd
	...
	GENERIC, // "Generic"
	GEOIP_UPDATED, // "GeoIP database has been successfully updated"
	GEOIP_UPDATING, // "Updating GeoIP database..."
	GEOIP_UPDATING_FAILED, // "GeoIP database could not be updated"
